...
const initialCategories: Category[] = [
  {
    id: "1",
    name: "Premium",
    description: "Produk kategori premium dengan kualitas tinggi",
    createdAt: "2024-01-15",
  },
  {
    id: "2",
    name: "Standard",
    description: "Produk kategori standard untuk kebutuhan umum",
    createdAt: "2024-01-16",
  },
  {
    id: "3",
    name: "Economy",
    description: "Produk kategori ekonomis dengan harga terjangkau",
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <h1 className="text-3xl font-bold">Kategori 2</h1>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Kelola kategori produk tingkat 2 untuk sistem inventory Anda.</CardDescription>
