...
const initialUnits: Unit[] = [
  { id: "1", name: "Indonesian Rupiah", symbol: "Rp", status: true },
  { id: "2", name: "Chinese Yuan", symbol: "RMB", status: false },
  { id: "3", name: "Singapore Dollar", symbol: "SGD", status: true },
  { id: "4", name: "US Dollar", symbol: "USD", status: true },
];
    ...
    <div className="space-y-6">
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent>
          <form onSubmit={handleSubmit}>
            <DialogHeader>
              <DialogTitle>
                {editingUnit ? "Edit mata uang" : "Tambah mata uang Baru"}
              </DialogTitle>
            </DialogHeader>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Kelola mata uang untuk sistem inventory Anda.
          </CardDescription>
