                            ...
                            filteredPenjualans.map((penjualan) => (
                                <TableRow key={penjualan.id}>
                                    <TableCell className="font-medium">
                                        <span className="font-mono">{penjualan.id}</span>
                                    </TableCell>
                                    <TableCell className="font-medium">
                                    ...
                                    <TableCell>{formatMoney(penjualan.total_paid)}</TableCell>
                                        ...
                                        <DropdownMenu>
                                            ...
                                            <DropdownMenuContent align="end">
                                                ...
                                                {penjualan.status_penjualan ===
                                                    StatusPenjualanEnum.DRAFT && (
                                                        <DropdownMenuItem
                                                            onClick={() => handleDeleteClick(Number(penjualan.id))}
