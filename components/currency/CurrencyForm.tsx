...
const formSchema = z.object({
    ...
    symbol: z.string().min(2, {
        message: "Simbol harus memiliki minimal 2 karakter"
    }),
...
const CurrencyForm: React.FC<CurrencyFormProps> = ({editing = false, initialdata, onSubmit}) => {
            ...
            <div className="grid grid-cols-1 gap-4 py-4">
                <div className="flex flex-col space-y-4">
                    ...
                    <FormField control={form.control} name={"symbol"} render={({field}) => (
                        <FormItem>
                            <FormLabel className={"text-right min-w-[80px]"}>Simbol</FormLabel>
                            <div className="flex-1">
                                <FormControl>
                                    <Input placeholder="Masukkan Simbol"
                                           {...field}/>
                                </FormControl>
                            </div>
                        </FormItem>
