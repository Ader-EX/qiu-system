...
import {LaporanPenjualanRows, StockAdjustmentItem, StockAdjustmentReport, utilsService} from "@/services/utilsService";
...
const StockAdjDropdown = () => {
    ...
    const [reportData, setReportData] =
        useState<PaginatedResponse<StockAdjustmentItem> | null>(null);
                        ...
                        <Table className="min-w-full divide-y divide-gray-200">
                            <TableHeader className="bg-gray-50">
                                <TableRow
                                    ...
                                    <TableHead className="px-3 py-3">No. Transaksi</TableHead>
                                    <TableHead className="px-3 py-3">Item Code</TableHead>
                                    <TableHead className="px-3 py-3">Item Name</TableHead>
                                    <TableHead className="px-3 py-3">Qty Masuk</TableHead>
                                    <TableHead className="px-3 py-3">Qty Keluar</TableHead>
                                    <TableHead className="px-3 py-3">Qty Balance</TableHead>
                                    <TableHead className="px-3 py-3">Harga Masuk</TableHead>
                                    <TableHead className="px-3 py-3">Harga Keluar</TableHead>
                                    <TableHead className="px-3 py-3">HPP</TableHead>
                                </TableRow>
                            </TableHeader>
                                ...
                                {reportData?.data?.length ? (
                                    reportData.data?.map((row, index) => (
                                        ...
                                        >
                                            ...
                                            <TableCell className="px-3 py-4">
                                                <div title={row.no_transaksi}>{row.no_transaksi}</div>
                                            </TableCell>
                                            <TableCell className="px-3 py-4">
                                                {row.item_code || "-"}
                                            </TableCell>
                                            ...
                                            <TableCell className="px-3 py-4">
                                                {formatMoney(row.harga_masuk || 0) || 0}
                                            </TableCell>
                                            <TableCell className="px-3 py-4">
                                                {formatMoney(row.harga_keluar || 0) || "-"}
                                            </TableCell>
                                            <TableCell className="px-3 py-4">
