      ...
      <div className="relative min-w-0">
        {reportData?.data?.length === 0 ? (
          ...
          <div className="w-full min-w-0 overflow-x-auto">
            <Table className="min-w-[1600px] table-fixed border-collapse">
              ...
              <TableHeader className="bg-gray-50 sticky top-0 z-10">
                <TableRow className="text-left text-xs font-semibold uppercase tracking-wider text-gray-600">
                  <TableHead className="w-[120px] px-4 py-3">Date</TableHead>
                  ...
                  <TableHead className="w-[160px] px-4 py-3">
                    No Penjualan
                  </TableHead>
                  <TableHead className="w-[110px] px-4 py-3">Status</TableHead>
                  <TableHead className="w-[140px] px-4 py-3">
                    Item Code
                  </TableHead>
                  ...
                  <TableHead className="w-[90px]  px-4 py-3 text-right">
                    Qty
                  </TableHead>
                  <TableHead className="w-[120px] px-4 py-3 text-right">
                    Price
                  </TableHead>
                  <TableHead className="w-[120px] px-4 py-3 text-right">
                    Sub Total
                ...
                {reportData?.data?.length ? (
                  reportData.data.map((row, index) => (
                    ...
                    >
                      ...
                      <TableCell className="px-4 py-4 whitespace-nowrap text-right text-sm text-gray-900">
