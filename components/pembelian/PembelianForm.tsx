...
export default function PembelianForm({
    ...
    const form = useForm<PembelianFormData>({
        ...
        defaultValues: {
            ...
            warehouse_id: undefined, // Change from implicit to explicit
            customer_id: '',         // Explicit empty string
            top_id: undefined,       // Change from implicit to explicit
            discount: 0,
    ...
    useEffect(() => {
        ...
        const loadPembelianData = async () => {
            try {
                console.log('[PembelianForm] Loading data for edit mode, ID:', pembelianId);
    ...
    const handleSubmit = async (
        ...
        try {
            ...
            console.log('Edit condition (isEditMode && pembelianId):', isEditMode && pembelianId);
            console.log('========================');
            ...
            if (isEditMode && pembelianId) {
                ...
                console.log('Reason - isEditMode:', isEditMode, 'pembelianId:', pembelianId);
                                ...
                                <FormItem>
                                    <SearchableSelect
                                        ...
                                        renderLabel={(item: any) =>
                                            `${item.id} - ${item.name} ${item?.curr_rel?.symbol ? `(${item.curr_rel.symbol})` : ''}`
                                        }
                                    />
                                    <FormMessage/>
                                </FormItem>
                            ...
                            render={({field}) => (
                                <FormItem>
                                    <SearchableSelect
                                        ...
                                        fetchData={async (search) => {
                                            try {
                                                console.log('[Warehouse] Fetching with search:', search);
                            ...
                            render={({field}) => (
                                <FormItem>
                                    <SearchableSelect
                                        ...
                                        fetchData={async (search) => {
                                            try {
                                                console.log('[Payment] Fetching with search:', search);
