...
const penjualanSchema = z.object({
  ...
  customer_id: z.coerce.number().min(1, "Customer harus dipilih"),
        ...
        <form className="space-y-6">
          ...
          <FormSection title="Gudang & Customer">
              ...
              <div>
                ...
                >
                  <span className="text-sm">
                    {loadedData.customer_code || "-"} -{" "}
                    {loadedData.customer_name || "-"}
                  </span>
                </div>
              </div>
            ) : (
            ...
            <QuickFormSearchableField
              ...
              showCondition={(customerId) => customerId && customerId !== 0}
            />
            ...
            {!activeFields.top_id && (isEditMode || isViewMode) ? (
              <div>
                ...
                <div
                  ...
                  onClick={() =>
                    !isViewMode &&
                    setActiveFields((prev) => ({ ...prev, top_id: true }))
                  }
                >
                  <span className="text-sm">
