...
const roleDenyMap: Record<string, string[]> = {
    ...
    OWNER: ["Item", "Stock Adjustment", "Pembelian", "Penjualan", "Pembayaran", "Pengembalian", "Vendor", "Customer", "Pengaturan"],  // Only Dashboard & Laporan
    SUPERVISOR: ["Pembayaran", "Pengembalian"],  // Can't see payment-related items
    STAFF: ["Pembelian", "Penjualan", "Pembayaran", "Pengembalian", "Vendor", "Customer", "Laporan", "Pengaturan"],  // Limited access
};
...
export function AppSidebar({...props}: React.ComponentProps<typeof Sidebar>) {
    ...
    const accessibleNav = allNavItems.filter((item) =>
        !roleDenyMap[role]?.includes(item.title)
    );
