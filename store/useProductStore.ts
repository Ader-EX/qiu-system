...
const useProductStore = create<ProductStore>((set, get) => ({
    ...
    setFilterKategori1: (filterKategori1) =>
        set({filterKategori1, currentPage: 1}),
    setFilterKategori2: (filterKategori2) =>
        set({filterKategori2, currentPage: 1}),
    ...
    getKategori1Options: () => {
        const state = get();
        const uniqueKategori1 = [
            ...new Set(state.products.map((p) => p.category_one_rel)),
        ];
    ...
    getKategori2Options: () => {
        const state = get();
        const uniqueKategori2 = [
            ...new Set(state.products.map((p) => p.category_two_rel)),
        ];
