...
import {SearchableSelectResponse, SearchableSelectResponseVendor, Vendor} from "@/types/types";
...
class VendorService {
    ...
    async getVendorById(id: string | number): Promise<Vendor> {
    ...
    async getForSearchable(id: string | number): Promise<SearchableSelectResponseVendor> {
